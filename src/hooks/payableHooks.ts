                    ...
                    await Payable.create(
                        {
                            ...
                            value: payable.value,
                            dueDate: nextDueDate(payable.dueDate as unknown as string, payable.recurrence) as any,
                            status: 'pendente',
                            ...
                            current_installment: currentInstallment ? currentInstallment + 1 : undefined,
